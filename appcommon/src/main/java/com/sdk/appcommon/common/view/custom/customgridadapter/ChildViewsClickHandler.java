 ...
 * under the License.
 */
package com.sdk.appcommon.common.view.custom.customgridadapter;
 ...
 * <p>
 * Whenever getNewCard() method is called ,a new CardViewHolder is
...
public final class ChildViewsClickHandler {
	...
	private static int TAG_VIEW_POSITION =-1;
	private static int TAG_CLICK_EVENT_ID = -2;
	 ...
	 * card view click events use  onCardClicked() call-back provided by
	 * GridAdapters.
	 * 
	 * @param childView
